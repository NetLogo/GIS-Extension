...
gis.jar gis.jar.pack.gz: $(SRCS) manifest.txt Makefile $(JARS) $(addsuffix .pack.gz, $(JARS))
	mkdir -p classes
...
jai_codec-1.1.3.jar jai_codec-1.1.3.jar.pack.gz:
	curl -f -S 'http://ccl.northwestern.edu/devel/jai_codec-1.1.3.jar' -o jai_codec-1.1.3.jar
...
jai_core-1.1.3.jar jai_core-1.1.3.jar.pack.gz:
	curl -f -S 'http://ccl.northwestern.edu/devel/jai_core-1.1.3.jar' -o jai_core-1.1.3.jar
...
ngunits-1.0.jar ngunits-1.0.jar.pack.gz:
	curl -f -S 'http://ccl.northwestern.edu/devel/ngunits-1.0.jar' -o ngunits-1.0.jar
...
jts-1.9.jar jts-1.9.jar.pack.gz:
	curl -f -S 'http://ccl.northwestern.edu/devel/jts-1.9.jar' -o jts-1.9.jar
...
commons-codec-1.3.jar commons-codec-1.3.jar.pack.gz:
	curl -f -S 'http://ccl.northwestern.edu/devel/commons-codec-1.3.jar' -o commons-codec-1.3.jar
...
commons-logging-1.1.jar commons-logging-1.1.jar.pack.gz:
	curl -f -S 'http://ccl.northwestern.edu/devel/commons-logging-1.1.jar' -o commons-logging-1.1.jar
...
commons-httpclient-3.0.1.jar commons-httpclient-3.0.1.jar.pack.gz:
	curl -f -S 'http://ccl.northwestern.edu/devel/commons-httpclient-3.0.1.jar' -o commons-httpclient-3.0.1.jar
